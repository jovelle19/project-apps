...
Route::post('/like-article', 'App\Http\Controllers\ArticleController@likeArticle');
Route::post('/unlike-article', 'App\Http\Controllers\ArticleController@unlikeArticle');
